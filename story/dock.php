...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['option1'])) {
        $orderController->addToArrayAndOpen('drowning');
...
?>
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title">The dock</h1>
                <p class="card-text">At the foot of the dock it is muddy and wet. The dock looks very old, 
                    and probably unsafe. Despite the dock being clearly out of shape you decide to venture onto it.</p>

                <form method="POST">
                    <input type="hidden" name="option1" value="true">
                    <button type="submit" class="btn btn-danger">Walk out onto the dock</button>
                </form>
                ...
                <form method="POST">
                    <input type="hidden" name="saveStory" value="dock">
