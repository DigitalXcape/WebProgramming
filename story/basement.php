...
?>
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title">Ending 3: Dream</h1>
                <p class="card-text">You fall through the floorboards into the basement. You then suddenly jerk out of bed. It was all a dream. <br> This ending has 2 routes.</p>
                ...
                <form method="POST">
                    <input type="hidden" name="saveStory" value="basement">
